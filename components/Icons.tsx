...
export const PigIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M15 11h.01"/><path d="M11.5 7.5c0-2.5 2-5 5-5s5 2.5 5 5c0 1.9-1 3.5-2.5 4.5"/><path d="M14 13.5c-1.5 1-5 1-7 0"/>
    <path d="M5.5 15.5C2.5 15.5 2 17 2 18.5c0 2.5 2 4.5 5 4.5h1c2 0 3-1 3-2.5a2.5 2.5 0 0 0-5-2.5"/>
    <path d="M12 3C4.2 3 4.2 8.4 4 10c-.2 1.6.3 3.2 1.5 4.5"/>
  </svg>
);
...
export const SyringeIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="m18 2 4 4"/><path d="m17 7-2.5-2.5"/><path d="M14 6 3 17.1C2.5 17.6 2 18.5 2 19.2V21h1.8c.7 0 1.6-.5 2.1-1L18 5"/><path d="m9 11 4 4"/><path d="M18 13-1.5 4.5"/><path d="m15 16 4 4"/>
    </svg>
);
...
export const HospitalIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M12 6v4"/><path d="M14 8h-4"/><path d="M20 10c0-1.1.9-2 2-2V6c0-1.1-.9-2-2-2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2v-2c-1.1 0-2-.9-2-2Z"/><path d="M12 12v4"/>
        <path d="M14 14h-4"/>
    </svg>
);
